...
The layout adapts to any screen size. On smaller displays the layer panel moves below the canvas and controls shrink so the app remains fully usable on phones and tablets.
