...
Use Ctrl/Cmd-click to select multiple layers at once; the "Centrar selección"
button in the properties panel moves every selected layer to the middle of the
canvas.
